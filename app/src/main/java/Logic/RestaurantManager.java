...
import sapir_liran.melzarito.UI.ChooseEmployeeRoleActivity;
...
//        database.setPersistenceEnabled(false);
    ...
    public void CreateNewOrderAndWriteToDB(int tableNumber) {
        ...
        Order new_order = new Order(orderIdCounter,tableNumber, ChooseEmployeeRoleActivity.loggedInUserName,new Date(),1,true,1);
